...
# installed.
TK_PREFIX='/Users/matthewgiordanella/Documents/projects/flask_movie/env'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/matthewgiordanella/Documents/projects/flask_movie/env'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/matthewgiordanella/Documents/projects/flask_movie/env/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='-------src-dir--------/tk8.5.18/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib/libtkstub8.5.a'
