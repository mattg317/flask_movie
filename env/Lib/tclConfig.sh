...
# installed.
TCL_PREFIX='/Users/matthewgiordanella/Documents/projects/flask_movie/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/matthewgiordanella/Documents/projects/flask_movie/env'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/matthewgiordanella/Documents/projects/flask_movie/env/include'
...
TCL_PACKAGE_PATH='/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='-------src-dir--------/tcl8.5.18/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/matthewgiordanella/Documents/projects/flask_movie/env/lib/libtclstub8.5.a'
